...
Example test_bin_incr1: bin_to_nat(Z) + 1 = bin_to_nat(incr(Z)).
Proof. simpl. reflexivity. Qed.

Example test_bin_incr2: bin_to_nat(B Z) + 1 = bin_to_nat(incr(B Z)).
Proof. simpl. reflexivity. Qed.

Example test_bin_incr3:  bin_to_nat(A (B Z)) + 1 = bin_to_nat(incr(A (B Z))).
Proof. simpl. reflexivity. Qed.

Example test_bin_incr4:  bin_to_nat(B (B Z)) + 1 = bin_to_nat(incr(B (B Z))).
Proof. simpl. reflexivity. Qed.

Example test_bin_incr5:  bin_to_nat(B (B (B Z))) + 1 = bin_to_nat(incr(B (B(B Z)))).
Proof. simpl. reflexivity. Qed.
