...
(** **** Exercise: 2 stars, standard, optional (le_Sn_n_inf)  
    ...
    Proof:  Any natural number cannot be less than or equal to its successor
            Thus, ~( S n <= n) for every natural number n
*)
...
(** Reflexivity and transitivity are the main concepts we'll need for
    ...
    relations in Coq, let's loo k at a few other common ones... *)
...
Lemma rev_trans: forall (X:Type) (R:relation X) (x y z: X),
  clos_refl_trans_1n R x y -> R y z -> clos_refl_trans_1n R x z.
Proof.
  intros X R x y z.
  intros Hxy Ryz.
  induction Hxy.
  - apply rsc_R. apply Ryz.
  - apply rt1n_trans with y.
    { apply Hxy. }
    { apply IHHxy. apply Ryz. }
Qed.
